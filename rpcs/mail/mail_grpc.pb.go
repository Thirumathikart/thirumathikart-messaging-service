...
type MailServiceClient interface {
	SendSingleMailRPC(ctx context.Context, in *SingleMailRequest, opts ...grpc.CallOption) (*SingleMailResponse, error)
}
...
func (c *mailServiceClient) SendSingleMailRPC(ctx context.Context, in *SingleMailRequest, opts ...grpc.CallOption) (*SingleMailResponse, error) {
	out := new(SingleMailResponse)
	err := c.cc.Invoke(ctx, "/rpcs.MailService/SendSingleMailRPC", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MailServiceServer interface {
	SendSingleMailRPC(context.Context, *SingleMailRequest) (*SingleMailResponse, error)
...
func (UnimplementedMailServiceServer) SendSingleMailRPC(context.Context, *SingleMailRequest) (*SingleMailResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SendSingleMailRPC not implemented")
}
...
func _MailService_SendSingleMailRPC_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SingleMailRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MailServiceServer).SendSingleMailRPC(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/rpcs.MailService/SendSingleMailRPC",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MailServiceServer).SendSingleMailRPC(ctx, req.(*SingleMailRequest))
	}
...
var MailService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "SendSingleMailRPC",
			Handler:    _MailService_SendSingleMailRPC_Handler,
		},
	},
